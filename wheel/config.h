...
const int WHEEL_DEGS_LIMIT = 540;      // the limit of degs to the one side [90, 180, 360, 420, 540, 720, 900, or another values..]

const float WHEEL_DEAD_ZONE = 1.1;     // [0.0, 100.0]
...
const float FEEDBACK_DEAD_ZONE = 5.5;  // [0.0, 100.0]

const float FEEDBACK_MIN_SPEED = 50.0;   // [0.0, 100.0]
const float FEEDBACK_MAX_SPEED = 64.0;   // [0.0, 100.0]
