...
const float WHEEL_DEAD_ZONE = 1.2;     // [0.0, 100.0]

// ----------- FEEDBACK MOTOR: --------------

const int FEEDBACK_PWM_L_PIN = 7;
const int FEEDBACK_PWM_R_PIN = 8;
const int FEEDBACK_EN_PIN = 9;       // WARNING!: The pin timer must be set to 16-20 kHz, depending on the motor (see function setupPWMFrequency() in 'wheel/wheel.ino').

const float FEEDBACK_DEAD_ZONE = 5.0;  // [0.0, 100.0]

const float FEEDBACK_MIN_SPEED = 55.0;   // [0.0, 100.0]
const float FEEDBACK_MAX_SPEED = 60.0;   // [0.0, 100.0]


// -------------- PEDALS: -------------------

const int PEDAL_GAS_PIN = A3;
const int PEDAL_BRAKE_PIN = A1;
const int PEDAL_CLUTCH_PIN = A2;
...
const int TRANSMISSION_UP_PIN = 4;
const int TRANSMISSION_DOWN_PIN = 5;
const int HANDBRAKE_PIN = 6;
