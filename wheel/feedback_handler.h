...
const float FEEDBACK_MIN_SPEED_VALUE = (float)PWM_MAX_VALUE * FEEDBACK_MIN_SPEED / 100;
const float FEEDBACK_MAX_SPEED_VALUE = (float)PWM_MAX_VALUE * FEEDBACK_MAX_SPEED / 100;
