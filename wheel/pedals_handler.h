const float PEDAL_CLUTCH_DEAD_ZONE_VALUE = PEDAL_CLUTCH_MAX_VALUE * PEDAL_CLUTCH_DEAD_ZONE / 100;
const float PEDAL_GAS_DEAD_ZONE_VALUE = PEDAL_GAS_MAX_VALUE * PEDAL_GAS_DEAD_ZONE / 100;
const float PEDAL_BRAKE_DEAD_ZONE_VALUE = PEDAL_BRAKE_MAX_VALUE * PEDAL_BRAKE_DEAD_ZONE / 100;
